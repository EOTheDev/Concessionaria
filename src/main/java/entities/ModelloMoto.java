...
public class ModelloMoto extends MarcaMoto {

	private String modello = " ";

	public ModelloMoto(String marca, String modello) {
		super(marca);
	...
	public String toString() {
		return "ModelloMoto [modello=" + modello + ", marca=" + marca + ", id=" + id + ", velocit‡Max=" + velocit‡Max
				+ ", cilindrata=" + cilindrata + ", marce=" + marce + ", pesoVuoto=" + pesoVuoto + ", carburante="
				+ carburante + ", capienzaPersone=" + capienzaPersone + ", tipoDiCambio=" + tipoDiCambio + ", colore="
				+ colore + ", URLImg=" + URLImg + ", optional=" + optional + ", rimanenza=" + rimanenza + ", ruote="
				+ ruote + "]";
	}
